    ...
    if(isset($_SESSION['views']))
    {
        ...
        ?>
            <form action="insert.php" method="post">
                ...
                <input type="id" name="id" required placeholder="id">
                <input type="nim" name="nim" required placeholder="nim">
                <input type="alamat" name="alamat" required placeholder="alamat">
                <input type="programstudi" name="programstudi" required placeholder="programstudi">
                <input type="status" name="status" required placeholder="status">
